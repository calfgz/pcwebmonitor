 ...
 * <p>
 * <access> <methodName>(){ if(handle==null){ return
 * <proxyMethodName>(); }else{ return
...
public class ProxyMethodVisitor extends GeneratorAdapter implements Constants, Opcodes {
	...
	public ProxyMethodVisitor(int access, Method method, MethodVisitor mv, Type classType, String targetMethodName, String handlerFieldName,
	...
	public void visitCode() {
		...
		pushThis();
		getStatic(classType, methodFieldName, Type.getType(java.lang.reflect.Method.class));
		getStatic(classType, methodProxyFieldName, Type.getType(java.lang.reflect.Method.class));
		loadArgArray();
