...
public class PackageEnhancer {
	...
	/**
	 * 对包中所有的类进行字节码增强，但是不指定handle，而由运行时指定(
	 * 调用StaticHandleFactory进行handle注册)
	 * 
	 * @param pckName
	 * @return
	 * @throws IOException
	...
	public Class[] createPackage(ClassLoader definedLoader, String pckName) throws InjectException {
	 ...
	 * @throws IOException
	 */
	public Class[] createPackage(String pckName, MethodInjectHandlerFactory factory) throws InjectException {
		return createPackage(null, pckName, factory);
	}

	public Class[] createPackage(ClassLoader definedLoader, String pckName, MethodInjectHandlerFactory factory) throws InjectException {
		Class[] cls = null;
	...
	public Class[] createPackage(String pckName, MethodInjectHandler handle) throws InjectException {
		return createPackage(pckName, handle, null);
	}

	public Class[] createPackage(String pckName, MethodInjectHandler handle, ClassLoader definedLoader) throws InjectException {
		Class[] cls = null;
