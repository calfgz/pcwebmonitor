...
public class ClassEnhancer {
	 ...
	 * @throws InjectException
	 */
	public Class createClass(String oriClassName, MethodInjectHandlerFactory factory, ClassLoader definedLoader, boolean injectSuper)
			throws ClassNotFoundException, InjectException {
	...
	public Class createClass(ClassLoader definedLoader, String oriClassName, MethodInjectHandler handle, boolean injectSuper) throws ClassNotFoundException,
			InjectException {
		Class cls = null;
