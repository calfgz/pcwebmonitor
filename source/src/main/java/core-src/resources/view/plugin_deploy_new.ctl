	...
	<body id="docs">
		...
		<div class="block">
			<div id="top">
				...
				or use relative path which start with '&amp;{ABSOLUTE_PATH}',like '&amp;{ABSOLUTE_PATH}/tracer.jar'.PCWebMonitor will find the plugin jar file in the classpath.
				</p>
				</div>
			</div> 
			<div id="center" >
				<div class='form'  >
					<form id='pluginAddForm' action='add' method='POST'  target='_self' >
	                    ...
	                    <p class="content">
						The name of this PCWebMonitor plugin.
						</p>
	                    <div class="x-form-item">
	                    ...
	                    <p class="content">
						The path of this plugin.The path can use absolute path,or use relative path which start with '&amp;{ABSOLUTE_PATH}',like '${ABSOLUTE_PATH}/tracer.jar'.PCWebMonitor will find the plugin jar file in the classpath.
						</p>
