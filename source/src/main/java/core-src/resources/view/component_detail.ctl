	...
	<body id="docs">
		...
		<div class="block">
			<div id="top">
				...
				<p class="content">
				This page allows you to define the general configuration of this PCWebMonitor component. 
				</p>
				</div>
			</div> 
			<div id="center" >
				<div class='form'  >
					<form action='save' method='POST'  >
	                    ...
	                    <p class="content">
						The name of this PCWebMonitor component
						</p>
	                    <div class="x-form-item">
	                    ...
	                    <p class="content">
						The class of this PCWebMonitor component
						</p>
						$for{param:params}
						<div class="x-form-item">
						...
						<div class="x-form-button">
							<input type="button" class='buttons' value=" Back " onclick="javascript:window.location='../../plugins/detail?pluginName=Tracer';">&nbsp;
